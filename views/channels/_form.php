...
<div class="channel-form">
    ...
    echo $form->field($model, 'tagIds')->dropDownList($tagsList, ['multiple' => true, 'id' => 'channel-tagids']);
    ?>
    ...
    <?php $this->registerJs("jQuery('#channel-tagids').select2({placeholder: 'Выберите теги', width: '100%'});"); ?>
